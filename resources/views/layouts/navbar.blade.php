  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top bg-light "style="outline:none;" >
      ...
      <div class="container">
          ...
          <form class="form-inline my-2 my-lg-0" action="/point" method="POST"> 
          @csrf
              <div class="search_field"style="background-color:#fff">
                  <i class="fas fa-search"></i>
                <input name="q" id="q" type="text" class="input" placeholder="Search">
            ...
            <li class="nav-item dropdown"class= "nav-item active">
                ...
                <div class="dropdown-menu " aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="{{ asset('/') }}">Accueil</a>
                  <a class="dropdown-item" href="{{ asset('/code') }}">Mon code</a>
                  <a class="dropdown-item" href="{{ asset('/forum') }}">Forum</a>
                  <a class="dropdown-item" href="{{ asset('/offre') }}">Offres</a>
                  <a class="dropdown-item" href="{{ asset('/devenirhote') }}">Devenir Hôte</a>
                  <a class="dropdown-item" href="{{ asset('/A-Propos') }}">A  propos de nous</a>
                  <a class="dropdown-item" href="{{ asset('mailto:Bluesekure@gmail.com') }}">Contactez nous</a>
...
<section>
 ...
 <a href="{{ asset('/devenirhote') }}"> <button id="topBtn" class="btn btn-default topBtn"><p class="vericaltext">Devenir hote</p></button></a>
